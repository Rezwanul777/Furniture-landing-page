...
const Materials = ({product}) => {
  return (
    ...
    className='md:w-1/2 mx-auto'>
        ...
        <h2 className='text-4xl font-bold mb-4 capitalize lg:w-2/3 '>Very serious<br></br> materials for making furniture</h2>
    ...
    initial="hidden"
    whileInView={"visible"}
    className='md:w-1/2 grid grid-cols-2 md:grid-cols-3 md:items-end items-center '>
        <div className=''>
